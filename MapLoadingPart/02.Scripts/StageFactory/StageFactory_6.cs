...
namespace hcp {
    public class StageFactory_6 :MonoBehaviour  {
        ...
        void Stage_6_Making()
        {
            ...
            StageST.EnqueStageTurningPoint(Constants.turningTerm * 4 + 1, E_WhichTurn.RIGHT);
            ...
            StageST.EnqueStageObjs(E_SPAWN_OBJ_TYPE.BALL, E_SPAWN_OBJ_TYPE.BALL, E_SPAWN_OBJ_TYPE.NOTHING);
            StageST.EnqueStageObjs(E_SPAWN_OBJ_TYPE.UPPER_HUDDLE_3, E_SPAWN_OBJ_TYPE.NOTHING, E_SPAWN_OBJ_TYPE.COIN_STRAIGHT);
            StageST.EnqueStageObjs(E_SPAWN_OBJ_TYPE.NOTHING, E_SPAWN_OBJ_TYPE.NOTHING, E_SPAWN_OBJ_TYPE.NOTHING);
            ...
            StageST.EnqueStageObjs(E_SPAWN_OBJ_TYPE.NOTHING, E_SPAWN_OBJ_TYPE.NOTHING, E_SPAWN_OBJ_TYPE.COIN_STRAIGHT);
            StageST.EnqueStageObjs(E_SPAWN_OBJ_TYPE.NOTHING, E_SPAWN_OBJ_TYPE.INVINCIBLE, E_SPAWN_OBJ_TYPE.COIN_STRAIGHT);
